...
% TODO: Update the code to generate this figure using the mitigation class
\begin{figure}[!htb]
...
\begin{figure}
  \includegraphics[width=\textwidth]{sorption_reduction_time.pdf}
  \caption{}
  \label{fig:sorption_reduction_time}
\end{figure}
