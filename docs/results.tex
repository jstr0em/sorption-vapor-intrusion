...
In the bottom panel of Figure \ref{fig:sorption_reduction_time} we quantified the number of hours for a fifty percent, a one, and two orders of magnitude reduction in indoor air concentration to occurs, both absent sorbing indoor materials (the reference case) and in the presence of the one's presented earlier in this work.
...
This indicates the significant effect that sorption of TCE onto cinderblock can potentially have on the efficacy on a VI mitigation scheme, with the remaining materials having a relatively minor or moderate effect; a trend we've seen in other parts of this work.\par
