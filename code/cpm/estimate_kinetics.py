...
class Kinetics:
    ...
    def get_gas_conc(self):
        ...
        c = P * part_by_part / (R * T)  # concetration of TCE (g/m^3)
        return c
    ...
    def get_material_density(self):
        ...
        density = {'drywall': 0.6e6, 'concrete': 2.0e6,
                   'carpet': 1.314e6, 'wood': 0.86e6, 'paper': 0.8e6, }
    ...
    def solve_reaction(self, t, k1, k2):
        c_star = odeint(self.rate_equation, t=t, y0=0, args=(k1, k2))
    ...
    def get_reaction_constants(self):
        ...
        popt, pcov = curve_fit(self.solve_reaction, t_data, c_star_data)
